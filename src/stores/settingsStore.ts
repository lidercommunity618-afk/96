    ...
    }),
    {
      ...
      migrate: (persisted, version) => {
        ...
        if (version < 14) {
          ...
          //    существующих пользователей в localStorage нет 4 новых полей
          //    (harmonicMinLegAtr/harmonicFibTolerancePct/harmonicHtfFactor/
          //    harmonicMinRR) → без этого шага они были бы undefined →
          //    NaN в расчётах ZigZag/допусков. Прецедент: version < 2.
          const ind = (s.indicators ?? {}) as Record<string, number>;
          ...
          if (typeof ind.harmonicMinRR !== 'number') ind.harmonicMinRR = DEFAULT_INDICATOR_CONFIG.harmonicMinRR;
          s.indicators = ind;
